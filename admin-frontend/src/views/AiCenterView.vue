  ...
  <div class="ai-page" v-loading="loading && !aiStore.streaming">
    ...
    <section class="panel log-panel">
      ...
      <el-table :data="logs" class="soft-table">
        <el-table-column prop="question" label="用户问题" min-width="320" show-overflow-tooltip />
        <el-table-column prop="answer" label="AI回复" min-width="480" show-overflow-tooltip />
