...
export interface ExaminationAiReview{id:number;examinationId:number;patientId:number;labStaffId?:number;reviewResult:string;reviewScore:number;abnormalItems?:string;logicIssues?:string;historyCompare?:string;warnings?:string;suggestions?:string;rawResponse?:string;reviewTime:string}
