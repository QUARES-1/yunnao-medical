    ...
    <view class="department-grid">
      ...
      >
        ...
        <view class="department-content">
          ...
          <text class="department-desc">{{ department.description || '专业门诊与疾病诊疗' }}</text>
        </view>
