<template>
  <el-container class="admin-shell">
    <el-aside width="252px" class="sidebar">
      ...
      <div class="system-card"><div class="pulse"></div><div><strong>系统服务正常</strong><span>API 与数据库连接稳定</span></div></div>
    </el-aside>
    <el-container>
